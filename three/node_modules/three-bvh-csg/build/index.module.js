import { BufferAttribute, Vector3, Mesh, Matrix4, Line3, Plane, Triangle, Ray, Vector4, DoubleSide, Matrix3, BufferGeometry, Group, Color, MeshPhongMaterial, MathUtils, LineSegments, LineBasicMaterial, InstancedMesh, SphereGeometry, MeshBasicMaterial } from 'three';
	...
	splitByPlane( plane, triangle = null ) {
		...
		for ( let i = 0, l = triangles.length; i < l; i ++ ) {
			...
			if ( splittingTriangle ) {
				...
				if ( ! splittingTriangle.intersectsTriangle( tri, _edge$1, true ) ) {
...
export { ADDITION, Brush, DIFFERENCE, EdgesHelper, Evaluator, GridMaterial, HalfEdgeHelper, HalfEdgeMap, INTERSECTION, Operation, OperationGroup, PointsHelper, REVERSE_SUBTRACTION, SUBTRACTION, TriangleSetHelper, TriangleSplitter, computeMeshVolume, generateRandomTriangleColors, getTriangleDefinitions, isTriDegenerate, logTriangleDefinitions };
